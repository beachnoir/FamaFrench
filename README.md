...
| 5 | [Practical Factor Investing](05_Practical_Factor_Investing.ipynb) | Real ETF return data, FF5+Momentum regressions on daily data, portfolio construction, factor profiles, limitations of short samples |
